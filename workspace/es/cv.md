...
Ingeniero Full Stack | APIs (REST / SOAP) | Microservicios / Microfrontends | Consultor Técnico | Data Engineer
...
## Experiencia clave
- Desarrollo backend: .NET, Java, Python
- Desarrollo frontend: Angular, React, Flutter
- Diseño e integración de APIs: REST, SOAP, gRPC
- Sistemas distribuidos y microservicios
- Mensajería y arquitectura orientada a eventos (AMQP)
- Comunicación en tiempo real (WebSockets)
- Nube y contenerización: AWS, Docker, Kubernetes
- Bases de datos: SQL y NoSQL
- Integración de sistemas y consultoría técnica
...
## Educación
- Universidad Alejandro de Humboldt — Título de Ingeniero, Informática (ago 2002 - jun 2007)
